define('components/tab/demo/demo4.jsx', function(require, exports, module) {
  ...
  var Demo = (function (_React$Component) {
    ...
    _createClass(Demo, [{
      key: 'onBeforeActive',
      value: function onBeforeActive(next) {
        if (next === 0) {
          alert('选不中第 0 项');
          return false;
        }
  ...
  _reactDom2['default'].render(_react2['default'].createElement(Demo, null), document.getElementById('demo4'));
